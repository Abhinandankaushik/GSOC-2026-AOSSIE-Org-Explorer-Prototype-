    ...
    <div className="space-y-4">
      ...
      >
        ...
        <Select value={langFilter} onValueChange={setLangFilter}>
          <SelectTrigger className="w-[160px] bg-surface-page border-border text-sm">
              ...
              {filtered.map((repo, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-3 text-right text-xs font-mono text-foreground">{repo.stargazers_count.toLocaleString()}</td>
                    <td className="p-3 text-right text-xs font-mono text-foreground">{repo.forks_count.toLocaleString()}</td>
                    <td className="p-3 text-right text-xs font-mono text-foreground">{repo.open_issues_count.toLocaleString()}</td>
